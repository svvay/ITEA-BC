import sys
sys.path.append("/home/oksana/itea-bc/Oksana_Yeroshenko")

from 5_fun_practise_yeroshenko_4 import x_sum
from 5_fun_practise_yeroshenko_1 import maxx
import pytest

def test_x_sum():
    assert (1 + 2 + 3 + 33) == 39, "Should be 39"
    assert (1 + -2 + 3 + 33) == 35, "Should be 35"
    assert (-1 + -2 + -3 + -33) == "Should be -39"
